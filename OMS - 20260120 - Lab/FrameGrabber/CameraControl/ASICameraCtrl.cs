    ...
    public class ASICameraCtrl
    {
        ...
        public struct ASI_CAMERA_INFO
        {
            ...
            public string Name
            {
                get
                {
                    return Encoding.ASCII.GetString(name).TrimEnd((Char)0);
                }
            }
        };
        ...
        public struct ASI_CONTROL_CAPS
        {
            ...
            public string Description
            {
                get
                {
                    return Encoding.ASCII.GetString(description).TrimEnd((Char)0);
                }
            }
        }
        ...
        public struct ASI_ID
        {
            ...
            public string ID
            {
                get
                {
                    return Encoding.ASCII.GetString(id).TrimEnd((Char)0);
                }
            }
        }
        ...
        public static int ASIGetNumOfConnectedCameras()
        {
            return IntPtr.Size == 8 /* 64bit */ ? ASIGetNumOfConnectedCameras64() : ASIGetNumOfConnectedCameras32();
        }
