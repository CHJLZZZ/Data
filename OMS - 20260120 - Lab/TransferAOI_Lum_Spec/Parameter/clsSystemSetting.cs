...
namespace OpticalMeasuringSystem
{
    public class clsSystemSetting
    {
        ...
        [Category("05. CircleTac"), DisplayName("01. Init Pos : Focuser"), Description("")]
        public int CircleTac_InitPos_Focuser { get; set; } = 0;

        [Category("05. CircleTac"), DisplayName("02. Init Pos : Aperture"), Description("")]
        public int CircleTac_InitPos_Aperture { get; set; } = 0;

        [Category("05. CircleTac"), DisplayName("03. Init Pos : XYZ Filter"), Description("")]
        public int CircleTac_InitPos_FW1 { get; set; } = 0;

        [Category("05. CircleTac"), DisplayName("04. Init Pos : ND Filter"), Description("")]
        public int CircleTac_InitPos_FW2 { get; set; } = 0;

        [Category("05. CircleTac Mcu Setting"), DisplayName("01. Read Mcu"), Description("")]
        public bool CircleTac_ReadMcu { get; set; } = false;

        [TypeConverter(typeof(ExpandableObjectConverter))]
        [Category("05. CircleTac Mcu Setting"), DisplayName("02. Focuser Default Para"), Description("")]
        public CircleTacCtrl.MotorSetting CircleTac_McuDefault_Focuser { get; set; } = new CircleTacCtrl.MotorSetting 
        {
            HomeSpeed = 50000,
            RunSpeed = 500000,
            ZeroPos = 30000,
        ...
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [Category("05. CircleTac Mcu Setting"), DisplayName("03. Aperture Default Para"), Description("")]
        public CircleTacCtrl.MotorSetting CircleTac_McuDefault_Aperture { get; set; } = new CircleTacCtrl.MotorSetting
        {
            HomeSpeed = 50000,
            RunSpeed = 500000,
            ZeroPos = 30000,
        ...
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [Category("05. CircleTac Mcu Setting"), DisplayName("04. XYZ Filter Default Para"), Description("")]
        public CircleTacCtrl.MotorSetting CircleTac_McuDefault_FW1 { get; set; } = new CircleTacCtrl.MotorSetting
        {
            HomeSpeed = 20000,
            RunSpeed = 1000000,
            ZeroPos = -200,
        ...
        [TypeConverter(typeof(ExpandableObjectConverter))]
        [Category("05. CircleTac Mcu Setting"), DisplayName("05. ND Filter Default Para"), Description("")]
        public CircleTacCtrl.MotorSetting CircleTac_McuDefault_FW2 { get; set; } = new CircleTacCtrl.MotorSetting
        {
            HomeSpeed = 20000,
            RunSpeed = 1000000,
            ZeroPos = -200,
