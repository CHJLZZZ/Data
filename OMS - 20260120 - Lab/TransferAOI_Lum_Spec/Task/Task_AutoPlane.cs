...
namespace OpticalMeasuringSystem
{
    ...
    public class Task_AutoPlane
    {
        ...
        public event Action<double, double> Update_P1_Diff;
        public event Action<double, double> Update_P2_Diff;
        public event Action<double, double> Update_P3_Diff;
        public event Action<double, double> Update_P4_Diff;
        public event Action<Point[], Point[]> DrawBox;
        ...
        public void Calculate_CornerPoints_And_BoxPoints(int Threshold, bool Debug = true)
        {
            ...
            {
                double P1_Diff_X = Math.Abs(this.Source_Points[0].X - this.Target_Points[0].X);
                double P1_Diff_Y = Math.Abs(this.Source_Points[0].Y - this.Target_Points[0].Y);
                Update_P1_Diff?.Invoke(P1_Diff_X, P1_Diff_Y);

                double P2_Diff_X = Math.Abs(this.Source_Points[1].X - this.Target_Points[1].X);
                double P2_Diff_Y = Math.Abs(this.Source_Points[1].Y - this.Target_Points[1].Y);
                Update_P2_Diff?.Invoke(P2_Diff_X, P2_Diff_Y);

                double P3_Diff_X = Math.Abs(this.Source_Points[2].X - this.Target_Points[2].X);
                double P3_Diff_Y = Math.Abs(this.Source_Points[2].Y - this.Target_Points[2].Y);
                Update_P3_Diff?.Invoke(P3_Diff_X, P3_Diff_Y);

                double P4_Diff_X = Math.Abs(this.Source_Points[3].X - this.Target_Points[3].X);
                double P4_Diff_Y = Math.Abs(this.Source_Points[3].Y - this.Target_Points[3].Y);
                Update_P4_Diff?.Invoke(P4_Diff_X, P4_Diff_Y);


                DrawBox?.Invoke(this.Target_Points, this.Source_Points);
            }
        }
