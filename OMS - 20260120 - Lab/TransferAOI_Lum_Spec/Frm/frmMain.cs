...
namespace OpticalMeasuringSystem
{
    ...
    public partial class frmMain : MaterialForm
    {
        ...
        private void Motor_Init()
        {
            ...
            switch (Type)
            {
                ...
                case EnumMotoControlPackage.CircleTac:
                    {
                        this.motorControl = new CircleTacCtrl(this.Info);
                    }
                    break;
            }
                ...
                case EnumMotoControlPackage.CircleTac:
                    {
                        ...
                        bool ReadMcu = GlobalVar.SD.CircleTac_ReadMcu;
                        CircleTacCtrl.MotorSetting FocuserPara = GlobalVar.SD.CircleTac_McuDefault_Focuser;
                        CircleTacCtrl.MotorSetting AperturePara = GlobalVar.SD.CircleTac_McuDefault_Aperture;
                        CircleTacCtrl.MotorSetting FW1Para = GlobalVar.SD.CircleTac_McuDefault_FW1;
                        CircleTacCtrl.MotorSetting FW2Para = GlobalVar.SD.CircleTac_McuDefault_FW2;

                        CircleTac.Open(ReadMcu, FocuserPara, AperturePara, FW1Para, FW2Para);
        ...
        private void OphirLMMeasurement_Init()
        {
            OphirLMMeasurement = new OphirLMMeasurement_Ctrl(this.Info);

            if (GlobalConfig.BypassHardware) return;

            OphirLMMeasurement.ScanUsb();
            OphirLMMeasurement.OpenDevice();
        }
            ...
            else
            {
                ...
                else
                {
                    HardwareUnit FormPara = new HardwareUnit {
                        ...
                        OphirLMMeasurement = this.OphirLMMeasurement,
                    };
